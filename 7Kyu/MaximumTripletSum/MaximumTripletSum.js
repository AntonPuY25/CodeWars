function maxTriSum(numbers){
    const arrWithoutDuplicate = numbers.filter((item,index)=> numbers.indexOf(item) === index).sort((a,b)=>b-a)
    return arrWithoutDuplicate[0]+arrWithoutDuplicate[1]+arrWithoutDuplicate[2]
}
